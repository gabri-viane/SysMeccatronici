...
//Definisce il massimo numero di tratti di cui una legge di moto pu� essere composta
...
public:
	...
	* corrente in cui la scrittura � arrivata.
	* 
...
* 
* @param file_name Il nome del file in cui lo stream andr� a scrivere i comandi MATLAB
* 
